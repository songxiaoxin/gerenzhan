$(function() {
    ...
    $(".wave1").css({"left":-1760});
    $(".wave2").css({"left":-3360});
    $(".wave1").animate({"left":-3360},25000,"linear")
    $(".wave2").animate({"left":-1760},25000,"linear")
    setInterval(function(){
        $(".wave1").stop().css({"left":-1760});
        $(".wave2").stop().css({"left":-3360});
        $(".wave1").animate({"left":-3360},25000,"linear")
        $(".wave2").animate({"left":-1760},25000,"linear")
    },25000)
    $(".page3-left-main li").hover(function(e) {
        // 排他
        $(this).stop().fadeTo(500,1).siblings().stop().fadeTo(500,1)
    },function(){
        // 所有变不透明
        $(".page3-left-main li").stop().fadeTo(500,1)
    })
});
(function(a) {
